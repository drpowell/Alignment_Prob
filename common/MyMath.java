...
public final class MyMath {
    ...
    public static void main(String args[]) {
        ...
        /*
         * double s = Double.POSITIVE_INFINITY; for (double i=1; i <400;
         * i+=0.01) { double v1 = MyMath.logstar_continuous(i); double v2 =
         * MyMath.logstar_discrete((int)i); System.out.println(i+" "+v1+" "+v2);
         * //s = MyMath.logplus(v,s); //System.out.println("i="+i+" v="+v+"
         * sum="+s+" sum_p="+MyMath.exp2(-s));
         */
    }
}
