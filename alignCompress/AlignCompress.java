 ...
 * 
 * AlignCompress aligns two sequences using a modified DPA that allows the use
 * of a _model_ for each sequence.
 * 
 * 
...
import common.DNA;
import common.MarkovN_exact;
import common.MarkovN_fitted;
import common.Misc;
import common.Model_SeqAB;
import common.Mutation_1State;
import common.Mutation_3State;
import common.Mutation_FSM;
...
/**
 * BufferModel takes a model and a sequence and the sequence alphabet. It
 * precomputes the encoding length of every alphabet character for every
