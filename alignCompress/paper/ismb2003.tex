...
\def\plotwidth{0.55\columnwidth}
...
%\toappear{Submitted to the ISMB-2003 refereeing process 6 January 2003}
...
%, the details
%are given in Appendix~\ref{sec:mutations}.  
...
cut-off over the same data as the previous tests.  The cut-off used for
...
Unbiased &  prss & 195 & 0  \\ 
Unbiased & Sum & 226 & 14  \\ \hline

0-order & prss & 89 & 0  \\ 
0-order & Sum & 211 & 17  \\ \hline

Unbiased \& 0-order & prss & 160 & 0  \\ 
Unbiased \& 0-order & Sum & 222 & 9  \\  \hline

Blend Unbiased \& 1-order & prss & 224 & 135  \\ 
Blend Unbiased \& 1-order & Sum (default 1st order) & 248 & 957 \\ 
Blend Unbiased \& 1-order & Sum (blendModel) & 246 & 116 \\ 
\hline \end{tabular}
\normalsize
\end{center}
%\end{minipage}
...
To date, development of the M-alignment method has focused on DNA sequence
data.  Research is currently underway to extend M-alignment to protein
sequences.
